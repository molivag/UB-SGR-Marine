    ...
    >
      <div className="hs-carousel relative overflow-hidden w-full min-h-96 bg-white rounded-lg border-UBfoothead">
        <div className="hs-carousel-body absolute top-0 bottom-0 start-0 flex flex-nowrap transition-transform duration-700 opacity-0">
          ...
          <div className="hs-carousel-slide">
	  Lorem, ipsum dolor sit amet consectetur adipisicing elit. Velit quo distinctio sunt vitae quia explicabo omnis nostrum consectetur, ea culpa nam! Veniam nobis esse illum nihil autem temporibus eos voluptatem?
          </div>
        </div>
      </div>
